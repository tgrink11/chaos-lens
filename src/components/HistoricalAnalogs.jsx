export default function HistoricalAnalogs({ analogResults }) {
  ...
  return (
    <div className="bg-chaos-800 rounded-xl p-6 border border-chaos-600">
      <h2 className="text-lg font-semibold text-[#1a1a1a] mb-1 font-mono">Historical Analogs</h2>
      ...
      {/* Consensus summary */}
      {consensus && (
        <div className="mb-4 p-4 rounded-lg bg-[#f0f2f5] border border-chaos-600">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          <thead>
            <tr className="text-xs text-[#667085] uppercase tracking-wider border-b border-chaos-600">
          ...
          <tbody>
            {analogs.map((a, i) => (
              <tr key={i} className="border-b border-chaos-700 hover:bg-chaos-700/50">
                <td className="py-2 px-2 text-[#667085] font-mono">{i + 1}</td>
                <td className="py-2 px-2 text-center font-mono text-[#344054]">{a.signature.H}</td>
                <td className="py-2 px-2 text-center font-mono text-[#344054]">{a.signature.D}</td>
                <td className="py-2 px-2 text-center font-mono text-[#344054]">{a.signature.lambda}</td>
